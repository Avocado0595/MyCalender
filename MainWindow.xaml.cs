    ...
    public MainWindow()
        {
          ...
          /*  RegistryKey regkey = Registry.CurrentUser.CreateSubKey("Software\\LapLich");
            ...
            cbxTime.ItemsSource = InitNotifytime();
            try
            {
        ...
        {
            //dtpChosenDate.SelectedDate = DateTime.Now;
      ...
      void DefaultJob()
        ...
        void LoadDays(int month, int year)
        {
            ...
            for (int i = 1; i <= MyConst.dayOfMonth( month, year); i++)
            {
                ...
                btn.Margin = new Thickness(2, 2, 1.365, 2.096);
                ...
                btn.Tag = string.Format("{0:0#}{1:0#}{2:####}",currentDate.Day, currentDate.Month, currentDate.Year);
